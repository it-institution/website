...
description: "IT학회 블로그에 글을 작성하고 GitHub를 통해 PR을 올리는 방법을 단계별로 안내합니다."
...
[https://github.com/it-institution/website](https://github.com/it-institution/website)
...
```bash
git clone git@github.com:it-institution/website.git
```
...
1. 블로그 디렉토리는 `website/content/blog` 입니다.
...
- 정상적으로 진행한 결과
  ...
  remote:
  remote: GitHub found 1 vulnerability on it-institution/website's default branch (1 moderate). To find out more, visit:
  remote:      https://github.com/it-institution/website/security/dependabot/1
  remote:
  To github.com:it-institution/website.git
